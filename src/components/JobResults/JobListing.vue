  ...
  <li class="mb-7">
    ...
    >
      <div class="mx-8 border-b border-solid border-brand-gray-2 pb-2 pt-5">
        <h2 class="mb-2 text-2xl">Tehnical Program Manager, Perception, Augmented Reality</h2>
        ...
        <div>
          ...
          <div>
            <ul class="list-disc pl-8">
              ...
              <li>Experience analyzing data through querying database (e.q., SQL)</li>
            </ul>
          </div>
        </div>

        <div class="mt-2 text-center">
          <router-link to="/jobs/results/1" class="text-brand-blue-1">Expend</router-link>
        </div>
      </div>
    </router-link>
  </li>
